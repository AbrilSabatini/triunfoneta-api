...
export const CAMISETAS = [
  {
    ...
    options: [
      ...
      { text: 'Paraguay', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Brasil', isCorrect: true, order: 2 },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Dinamarca', isCorrect: false, order: 2 },
      { text: 'Suecia', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Gallo', isCorrect: true, order: 2 },
      { text: 'Toro', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Albiceleste titular', isCorrect: true, order: 2 },
      { text: 'Negra', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Brasil', isCorrect: true, order: 2 },
      { text: 'Uruguay', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Adidas', isCorrect: true, order: 2 },
      { text: 'Umbro', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Suiza', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Polonia', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Noruega', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Puma', isCorrect: false, order: 1 },
      { text: 'Le Coq Sportif', isCorrect: true, order: 2 },
      { text: 'Topper', isCorrect: false, order: 3 },
    ],
  },
];
