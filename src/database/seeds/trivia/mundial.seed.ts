...
export const MUNDIAL = [
  {
    ...
    options: [
      ...
      { text: 'Argentina', isCorrect: true, order: 2 },
      { text: 'Croacia', isCorrect: false, order: 3 },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Rodrigo De Paul', isCorrect: false, order: 2 },
      { text: 'Nicolás Otamendi', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Polonia', isCorrect: false, order: 2 },
      { text: 'Australia', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Toni Kroos', isCorrect: false, order: 2 },
      { text: 'Özil', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Argentina', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: '4 años', isCorrect: true, order: 2 },
      { text: '5 años', isCorrect: false, order: 3 },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: '1934', isCorrect: false, order: 2 },
      { text: '1938', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Brasil', isCorrect: false, order: 2 },
      { text: 'Croacia', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Italia', isCorrect: false, order: 1 },
      { text: 'Argentina', isCorrect: false, order: 2 },
      { text: 'Brasil', isCorrect: true, order: 3 },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Alemania', isCorrect: false, order: 2 },
      { text: 'Rusia', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Ubaldo Fillol', isCorrect: false, order: 2 },
      { text: 'Osvaldo Ardiles', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Estados Unidos', isCorrect: true, order: 2 },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Ghana', isCorrect: false, order: 2 },
      { text: 'Marruecos', isCorrect: true, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: '1946 y 1950', isCorrect: false, order: 2 },
      { text: 'Ninguno', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Klose', isCorrect: false, order: 2 },
      { text: 'Ronaldinho', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      { text: 'Alemania', isCorrect: false, order: 0 },
      { text: 'Italia', isCorrect: false, order: 1 },
      { text: 'España', isCorrect: true, order: 2 },
      { text: 'Francia', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Países Bajos', isCorrect: false, order: 2 },
      { text: 'Brasil', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Beckenbauer', isCorrect: false, order: 2 },
      { text: 'Paolo Maldini', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Inglaterra', isCorrect: false, order: 2 },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Croacia', isCorrect: true, order: 2 },
      { text: 'Marruecos', isCorrect: false, order: 3 },
    ],
  },
  {
    question:
    ...
    options: [
      ...
      { text: 'Croacia', isCorrect: true, order: 2 },
      { text: 'Países Bajos', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Paraguay', isCorrect: false, order: 2 },
      { text: 'México', isCorrect: false, order: 3 },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Suecia', isCorrect: false, order: 2 },
      { text: 'Dinamarca', isCorrect: false, order: 3 },
    ],
  },
];
